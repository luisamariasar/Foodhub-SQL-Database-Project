/* 
============================================================
FOODHUB BUSSINESS ANALYSIS AND DATABASE OPERATIONS
...
--Rider Registration
INSERT INTO Rider(EmployeeFirstName,EmployeeLastName,NIC,DateOfBirth,ContactNumber, LicenseNo, Address)
VALUES ('John','Smith','12345F','1998-04-15',' 0789569', 'YGH654', 'King Street 5');

--Customer Registration
INSERT INTO Customer (CustomerFirstName, CustomerLastName, NIC, DateOfBirth, 
ContactNumber, LocationNo, Street,City)
VALUES ('Alex','Brown', '64367D', '1995-03-20', '08987778', '34','king street', 'Oxford');
